...
GOOGLE_IMAGEN_SKILL: Skill = {
    "name": "google_imagen",
    "description": "Expert for Google Imagen 4 image generation. Optimizes prompts with subject+context+style structure, photography modifiers, and aspect ratios.",

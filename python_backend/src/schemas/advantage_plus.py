"""
Advantage+ Campaign Schemas - Meta Marketing API v25.0+

STRICT v25.0+ COMPLIANCE:
...
# =============================================================================
# ENUMS - v25.0+ Compliant Values Only
# =============================================================================

class AdvantageObjective(str, Enum):
    """
    Supported objectives for Advantage+ campaigns (v25.0+)
...
class AdvantageBidStrategy(str, Enum):
    """
    Supported bid strategies for Advantage+ Campaign Budget (v25.0+)
...
class AdvantageState(str, Enum):
    """
    Advantage+ campaign state (v25.0+)
...
# =============================================================================
# TARGETING - v25.0+ Advantage+ Audience
# =============================================================================
...
class TargetingAutomation(BaseModel):
    """
    Advantage+ Audience configuration (v25.0+)
...
class AdvantagePlusTargeting(BaseModel):
    """
    Targeting specification for Advantage+ campaigns (v25.0+)
...
class AdvantageStateInfo(BaseModel):
    """
    Read-only response from API showing Advantage+ status (v25.0+)
...
class CreateAdvantagePlusCampaignRequest(BaseModel):
    """
    Create Advantage+ Campaign - v25.0+ API
...
class CreateAdvantagePlusAdSetRequest(BaseModel):
    """
    Create Ad Set for Advantage+ Campaign - v25.0+ API
